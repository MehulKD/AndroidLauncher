...
public class CustomSpinnerAdapter extends ArrayAdapter<SpinnerItem> {
	...
	public CustomSpinnerAdapter(Context context, int layoutResourceID, int textViewResourceId,
	...
	public View getCustomView(int position, View convertView, ViewGroup parent) {
		...
		holder.userImage.setImageDrawable(row.getResources()
				.getDrawable(spinnerItem.getDrawableResID()));
